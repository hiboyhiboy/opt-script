...
# 菜单页面排序：空格隔开
menu_title1="配置扩展环境 锐捷认证 Wifidog 微信推送  网页终端    相框设置 goflyway virtualhere 自建微信推送 gotify推送"
...
menu_title5="搭建Web环境 caddy maddy v2ray  chinadns chinadns_ng 假装在中国 upd2pro 连接打印机 filemanager verysync clash"
################################
